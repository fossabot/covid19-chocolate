<template>
  <div class="Worker">
    ...
    <static-card>
      <h3>
        <app-link
          to="https://www.city.sagamihara.kanagawa.jp/sangyo/sangyo/1019826/1022793.html"
          :icon-size="24"
          >{{ $t('一時支援金【申請受付期限：令和3年5月31日（月曜日）】') }}
        </app-link>
      </h3>
      <p>
        {{
          $t(
            '緊急事態宣言に伴う飲食店時短営業又は外出自粛等の影響を受けており、1～3月のいずれかの月の売上が2019年比又は2020年比で50％以上減少した中小法人・個人事業者のための一時支援金'
          )
        }}
      </p>
    </static-card>
