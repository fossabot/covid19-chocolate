      ...
      <details>
        ...
        <div class="fade">
          ...
          <ul>
            ...
            <br />
            <p>
              {{ $t('集団接種：5月27日（木曜日）午前8時30分から【6月10日（木曜日）から6月27日（日曜日）までの接種　※木・土・日曜日のみ】') }}
            </p>
            <p>
              {{ $t('個別接種：5月31日（月曜日）午前8時30分から【6月7日（月曜日）以降分の接種　※接種期間は調整中】') }}
            </p>
          </ul>
          <br />
          <p>
          ...
          <div class="bold">
            {{
              $t(
                '2回目の予約方法が変更になりました（集団接種・個別接種ともに）'
              )
            }}
          </div>
          {{ $t('1回目の予約時、1回目接種の3週間後') }}
          <div class="bold">
            {{ $t('「同じ会場、同じ時間」') }}
          </div>
          {{ $t('で2回目の予約をお取りします。') }}
