        ...
        <template #additionalDescription>
          ...
          <ul>
            ...
            <li>
              {{
                $t(
                  'ワクチン接種記録システム（VRS）のデータを基に、接種券の発行市町村別に集計しています。登録にタイムラグがあるため、同じ日の接種実績でも、確認時点によって数値が異なる'
                )
              }}
            </li>
            <li>
            ...
            <li>
              {{
                $t(
                  '医療従事者等の記録は含まれていません。職域接種の記録は、接種券がVRSに読み取られた記録についてのみ反映されている'
                )
              }}
            </li>
          </ul>
