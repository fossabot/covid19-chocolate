<template>
  <div class="VaccineInfo">
    ...
    <div class="VaccineInfo-description">
      ...
      <div class="bold">
        {{
          $t('2回目の予約方法が変更になりました（集団接種・個別接種ともに）')
        }}
      </div>
      ...
      <details>
        ...
        <div class="fade">
            ...
            <tr>
              ...
              <th>
                ...
                <ul>
                  ...
                  <li>
                    {{
                      $t('グッディプレイス相模原3階（旧アイワールド相模原店）')
                    }}
                  </li>
                </ul>
              </th>
              <th>{{ $t('6月21日（月曜日）～7月11日（日曜日）') }}</th>
            </tr>
            <tr>
              <th>{{ $t('6月15日（火曜日）') }}</th>
              <th>{{ $t('72歳以上の方') }}</th>
          ...
          <p class="margin-b">
            {{
              $t(
                '以降の日程は新型コロナウイルスワクチンのページをご覧ください。'
              )
            }}
          </p>
          <div class="margin-b">
